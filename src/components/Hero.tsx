...
const Hero = ({ locationName = 'Jogja, Sleman, dan Bantul' }: HeroProps) => {
  return (
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-text-secondary mb-12 leading-relaxed max-w-xl">
              SerenaRaga menghadirkan layanan pijat panggilan yang nyaman dan personal langsung ke hunian Anda di wilayah {locationName}. Temukan ketenangan sejati tanpa harus keluar rumah.
            </p>
